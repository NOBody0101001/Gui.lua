...
-- Gerekli servisleri ve nesneleri al
local Players = game:GetService("Players")
local UserInputService = game:GetService("UserInputService")
...
-- GUI'nin ana özelliklerini ayarla
...
local function updateAim()
    if aimbotEnabled then
        ...
        if closestPlayer and closestPlayer.Character and closestPlayer.Character:FindFirstChild("Head") then
            ...
            local screenPosition = workspace.CurrentCamera:WorldToViewportPoint(headPosition)
            circle.Position = UDim2.new(0, screenPosition.X, 0, screenPosition.Y)
        end
    end
end

-- Butona tıklama işlevselliğini ayarla
...
-- Oyun süresince aimbot işlevini sürekli güncelle
