...
function startFlying()
    ...
    flyLoop = game:GetService("RunService").Stepped:Connect(function()
        ...
        local direction = Vector3.new(flyControl.R - flyControl.L, flyControl.F - flyControl.B, 0)
        bodyVelocity.Velocity = ((workspace.CurrentCamera.CoordinateFrame.lookVector * flyControl.F) + (workspace.CurrentCamera.CoordinateFrame.rightVector * flyControl.R) - (workspace.CurrentCamera.CoordinateFrame.rightVector * flyControl.L) - (workspace.CurrentCamera.CoordinateFrame.lookVector * flyControl.B)) * flySpeed
        bodyGyro.CFrame = workspace.CurrentCamera.CoordinateFrame * CFrame.Angles(-math.rad((flyControl.B - flyControl.F) * 50), 0, 0)
    end)
end
